...
namespace BaroChecklist
{
    class Item : TreeNode
    {
        ...
        public int ducatsRequired;
        public int creditsRequired;
        public string[] searchTags;

        public Item(string _itemName, string _itemType, int _ducats, int _credits, string[] _tags)
        {
            this.itemName = _itemName;
            this.itemType = _itemType;
            this.ducatsRequired = _ducats;
            this.creditsRequired = _credits;
            this.searchTags = _tags;
        }
    }
    ...
    class Utils
    {
        ...
        public static Image ResizeImage(Image image, PictureBox canvas, bool centerImage = true)
        {
